...
import { BsArrowUpCircleFill, BsTwitterX } from 'react-icons/bs';
        ...
        <section className="container-fluid main" id='1'>
            ...
            <motion.div
                ...
                <div className="contact-group d-flex flex-column gap-3">
                    ...
                    <a 
                        href="https://www.linkedin.com/in/santhossunthar/" 
                        className='d-flex gap-2 align-items-center'>
                            <FaLinkedinIn /> 
                            LinkedIn
                    </a>
            ...
            <div className={
                !scrolled ? "row bg-secondary header" : 
                    "row bg-secondary header-small-scrolled fixed-top"
                }>
                <div className="
                    col 
                    bg-primary 
            ...
            <div className={!scrolled ? "row bg-primary info" : "d-none"}>
                <div className={
                    !scrolled ? "col-md-6 profile-img-bg p-3" : 
                    "col-md-6 profile-img-col-scrolled h-25"
                    }>
                    <motion.div
                        initial={{ opacity: 1, y: 0 }}
                        animate={controls}
                        ...
                        transition={{ duration: 1 }}
                        className={
                            !scrolled ? "profile-img-small" : 
                            "profile-img-scrolled"
                        }>
                        <img src="/images/picture.jpg"
                            alt="Profile Picture" 
                ...
                <div className={
                    ...
                    <motion.div
                        ...
                        <ul className="
                            ...
                            <li className="list-group-item ps-3 pe-3">
                                <a href="https://x.com/santhossunthar" target='_blank'>
                                    <BsTwitterX size={25} />
                                </a>
                            </li>
                        </ul>
